...
tags={'commit':hash, 'script':script_name, 'folder':parent, 'repo_name':repo_name, 'strategy':'Prophet'}
...
for id_station in tqdm(ids_station):
    ...
    with mlflow.start_run(experiment_id='3',
        ...
        m.fit(dataset_[['y','ds']])  # Fit model with given params
        y_hat = m.predict(dataset_[['y','ds']])['yhat']
